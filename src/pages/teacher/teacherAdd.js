...
export default function TeacherAdd() {
    ...
    const handleLogin = async (e) => {
        ...
        if (response.ok) {
            toast.success("Teacher Login Details Added")
        }
        else {
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-3">
                            <div>
                                <div className="flex flex-col">
                                    ...
                                    <input onChange={handelInputChange} value={formData.fullName} name="fullName" required type="text" className="p-2 px-4 border border-blue-400 rounded" placeholder="Teacher FullName " />
                                </div>
                                <div className="flex flex-col mt-8">
                                    <label htmlFor="exp">Phone</label>
                                    <input onChange={handelInputChange} value={formData.mobile} name="mobile" required type="text" className="p-2 px-4 border border-blue-400 rounded" placeholder="mobile" />
                                </div>
                                <div className="flex flex-col mt-8">
                                    <label htmlFor="exp">Experience</label>
                                    <input onChange={handelInputChange} value={formData.experience} name='experience' required type="text" className="p-2 px-4 border border-blue-400 rounded" placeholder="Experience" />
                                </div>
                            </div>
                            ...
                            <div>
                                <div className="flex flex-col">
                                    ...
                                    <select onChange={handelInputChange} value={formData.gender} name="gender" required className="border border-blue-500 p-[10px] px-4 rounded">
                                        <option value={""}>
                                            Select Gender
                                        </option>
                                        <option value={"Male"}>
                                ...
                                <div className="flex flex-col mt-8">
                                    ...
                                    <input type="email" onChange={handelInputChange} value={formData.email} name="email" className="p-2 px-4 border border-blue-400 rounded" placeholder="Email" />
                                </div>

                                <div className="flex flex-col mt-8">
                                    <label htmlFor="">Joining Date</label>
                                    <input type="date" onChange={handelInputChange} value={formData.joiningDate} name="joiningDate" className="p-2 px-4 border border-blue-400 rounded" placeholder="Joining Date" />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col ">
                                    ...
                                    <input onChange={handelInputChange} value={formData.dob} name="dob" required type="date" className="p-2 px-4 border border-blue-400 rounded" placeholder="Enter Phone Number" />
                                </div>

                                <div className="flex flex-col mt-8">
                                    <label htmlFor="first" className="text-gray-600">Qualification</label>
                                    <input onChange={handelInputChange} value={formData.qualification} name="qualification" required type="text" className="p-2 px-4 border border-blue-400 rounded" placeholder="Teacher FullName " />
                                </div>
                            </div>
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="mt-5">
                                ...
                                <input onChange={handleFileChange} name="profile" type="file" id="file" className="hidden " />
